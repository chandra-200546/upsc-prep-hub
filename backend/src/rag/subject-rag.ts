...
export const seedGeographyBooksIfMissing = async () => {
  ...
  if (!foundPaths.length) {
    return {
      seeded: false,
      reason: "No geography PDF paths found. Set GEOGRAPHY_BOOK_PDF_PATHS / GEOGRAPHY_6TH_BOOK_PDF_PATH / GEOGRAPHY_7TH_BOOK_PDF_PATH / GEOGRAPHY_8TH_BOOK_PDF_PATH / GEOGRAPHY_9TH_BOOK_PDF_PATH in backend .env.",
    };
  }
